...
- **ذخیره و ادامه‌ی اسکن:** پیشرفت اسکن هر ۱۰۰ IP یک‌بار ذخیره می‌شود. اگر اسکن به هر دلیلی قطع شد، دفعه‌ی بعد می‌توانید از همان‌جا ادامه دهید
...
در هر دو حالت، پیشرفت اسکن هر ۱۰۰ IP یک‌بار در فایل `scan_checkpoint.json` ذخیره می‌شود. اگر اسکن به هر دلیلی قطع شود (Ctrl+C، قطع شدن برق، بسته شدن Termux)، دفعه‌ی بعد که ابزار را اجرا کنید می‌توانید از همان‌جا ادامه دهید.
...
پیشرفت هر ۱۰۰ IP یک‌بار ذخیره می‌شود. دفعه‌ی بعد که ابزار را اجرا کنید، اسکن ناتمام را تشخیص داده و می‌پرسد آیا می‌خواهید ادامه دهید یا از نو شروع کنید.
